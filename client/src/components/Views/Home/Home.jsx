  ...
  import {getvideoGames, setNxtPage,setPrvPage, getvGamebyName, set1rsPage,setPrvVideogame,filterByAtoZ,filterByZtoA,filterRatingAsc, filterRatingDesc, filterPriceAsc,filterPriceDesc, GetallGenres, filterByGenre,filterByPlatform, 
    ...
    FilterByAtoZDos, FilterByZtoADOS, FilterByPriceDescDOS, FilterByPriceAscDOS, FilterByRatingDescDOS, FilterByRatingAscDOS, filterByAtoZDOS, filterByZtoADOS, filterByRatingAscDOS, filterByRatingDescDOS, filterByPriceAscDOS, filterByPriceDescDOS, filterByPlatformDOS, emptyFilteredvideogames
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <TouchableOpacity
                    onPress={()=>handlerCleaner()}>
                      <MaterialCommunityIcons name='close-circle-outline' color={color_blanco} size={30} style={[styles.botonplus, { margin: 10 }]}/>
                    </TouchableOpacity>
                  </View>
